...
def find_word(word,df):
    ...
    neg_score = 0; pos_score = 0; neu_score = 0 
    word = word.lower()
...
def main():
    ...
    st.write('#### <span style="color:#f7ac54"> Important Note:</span> Please make sure your target texts are inside the column called "texts".',unsafe_allow_html=True)
    ...
    if uploaded_file is not None:
        ...
        for word in words_list: 
            ...
            st.write("Positive occurrence: ", positive, ' Negative occurrence: ', negative, " Neutral occurrence: ", neutral )
